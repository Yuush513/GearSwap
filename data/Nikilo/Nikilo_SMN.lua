...
function get_sets()
    ...
    sets.midcast.BP = {
		...
		back={ name="Conveyance Cape", augments={'Summoning magic skill +5','Pet: Enmity+10','Blood Pact Dmg.+1','Blood Pact ab. del. II -3',}},
    }
    ...
    sets.midcast["Shattersoul"] = {
		...
		left_ring="Stikini Ring +1",
		right_ring={ name="Metamor. Ring +1", augments={'Path: A',}},
		back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Accuracy+10 Pet: Rng. Acc.+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},
    }
    ...
    sets.pet_midcast.Physical_BP = {
		...
		body="Con. Doublet +2",
		hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+30 Pet: Rng. Acc.+30','Blood Pact Dmg.+9','Pet: INT+6','Pet: Mag. Acc.+9',}},
    ...
    sets.pet_midcast.Magic_BP_Base = {
		main={ name="Grioavolr", augments={'Blood Pact Dmg.+10','Pet: STR+5','Pet: Mag. Acc.+3','Pet: "Mag.Atk.Bns."+29',}},
		sub="Elan Strap +1",
		ammo="Sancus Sachet +1",
		head="C. Palug Crown",
		head={ name="Apogee Crown +1", augments={'MP+80','Pet: Attack+35','Blood Pact Dmg.+8',}},
		body={ name="Apo. Dalmatica +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}},
		hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+12 Pet: "Mag.Atk.Bns."+12','Blood Pact Dmg.+9','Pet: INT+4','Pet: Mag. Acc.+9','Pet: "Mag.Atk.Bns."+8',}},
		legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
		...
		right_ring={name="Varar Ring +1", bag="wardrobe2"},
		back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Eva.+20 /Mag. Eva.+20','Pet: Mag. Acc.+10','Pet: "Regen"+10','Phys. dmg. taken-10%',}},
    }
    ...
    sets.pet_midcast.Magic_BP_TP_Acc = set_combine(sets.pet_midcast.Magic_BP_TP, {body="Con. Doublet +2",})
 
    sets.pet_midcast.Magic_BP_NoTP_Acc = set_combine(sets.pet_midcast.Magic_BP_NoTP, {body="Con. Doublet +2",})
    ...
    sets.aftercast.Perp_Favor = set_combine(sets.aftercast.Perp_Refresh, {right_ring="Evoker's Ring",})
