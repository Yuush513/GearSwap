...
function job_setup()
	...
	cor_sub_weapons=S{"Rostam", "Demers. Degen +1", "Tauret", "Blurred Knife +1", "Gleti's Knife"}
...
function init_gear_sets()
   ...
   sets.precast.RA = {
		...
		body="Laksa. Frac +3", --20
		hands="Lanun Gants +3", --13
		legs="Adhemar Kecks +1", --10/13
		feet="Meg. Jam. +2", --10
		neck="Comm. Charm +2", --4
		waist="Impulse Belt", --5
		back={ name="Camulus's Mantle", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Snapshot"+10','Phys. dmg. taken-10%',}}, --10
		} --62/33
	
	-- Need 45
    sets.precast.RA.Flurry1 = set_combine(sets.precast.RA, {
		head="Chass. Tricorne +3", --0/18
    ...
    sets.Armageddon_M.Acc = {main=Rostam.B, sub=Rostam.B, ranged="Armageddon"}
    sets.Armageddon_R = {main=Rostam.A, sub="Tauret", ranged="Armageddon"}
    sets.Armageddon_R.Acc = sets.Armageddon_R
    sets.Fomalhaut_M = {main=Rostam.B, sub="Gleti's Knife", ranged="Fomalhaut"}
	...
	sets.Anarchy_AE = {main=Rostam.B, sub="Tauret", ranged="Anarchy +2"}
