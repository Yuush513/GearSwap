...
function get_sets()
    ...
    sets.midcast.BP = {
		...
		back={ name="Conveyance Cape", augments={'Summoning magic skill +3','Pet: Enmity+15','Blood Pact Dmg.+3','Blood Pact ab. del. II -3',}},
    }
    ...
    sets.midcast.EnmityRecast = set_combine(sets.precast.FC, {body="Apo. Dalmatica +1"})
 ...
 --   sets.midcast["Mana Cede"] = { hands="Beckoner's Bracers +1" }
    ...
    sets.pet_midcast.Physical_BP = {
		...
		body="Con. Doublet +3",
		hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+21 Pet: Rng. Acc.+21','Blood Pact Dmg.+9','Pet: DEX+7','Pet: "Mag.Atk.Bns."+4',}},
		...
		back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Accuracy+10 Pet: Rng. Acc.+10','Pet: "Regen"+10','Phys. dmg. taken-10%',}},
    }
    ...
    sets.pet_midcast.Magic_BP_Base = {
		main={ name="Grioavolr", augments={'Blood Pact Dmg.+10','Pet: MND+4','Pet: Mag. Acc.+19','Pet: "Mag.Atk.Bns."+28','DMG:+18',}},
		sub="Elan Strap +1",
		ammo="Sancus Sachet +1",
		head="C. Palug Crown",
		body={ name="Apo. Dalmatica +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}},
		hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+22','Blood Pact Dmg.+10','Pet: STR+5',}},
		legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
    ...
    sets.aftercast.Idle_Ilvl = set_combine(sets.aftercast.Idle, {feet="Baayami Sabots"})
	...
	if pet.isvalid then
        if pet.name=='Fenrir' then
            send_command('input /macro book 3;wait .1;input /macro set 1;wait 3;input /lockstyleset '..StartLockStyle)
